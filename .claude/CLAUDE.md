...
- **Technical Excellence:** Prioritize quality, simplicity, robustness, and maintainability over development cost. Do not take shortcuts based on human-like time constraints (e.g., assuming a proper solution takes too long to build). You write code instantly; lean towards the correct, long-term architectural solution. Design with strong invariants and make bad states physically impossible rather than adding defensive fallbacks or papering over unclear designs with more machinery.
